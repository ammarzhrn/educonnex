    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('news.index') }}">Articles Management</a></div>
        ...
        <div class="section-body">
            ...
            <p class="section-lead">
                Create / Request New News to be published.
            </p>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-4">
                                    <div class="col-sm-12 col-md-7 offset-md-3">
                                        <button type="submit" class="btn btn-primary">Request News</button>
                                    </div>
                                </div>
                            </div>
                        </form>
