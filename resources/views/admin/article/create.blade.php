    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('article.index') }}">Articles Management</a></div>
        ...
        <div class="section-body">
            ...
            <p class="section-lead">
                Create / Request New Article to be published.
            </p>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Article
                                        Content</label>
                                    <div class="col-sm-12 col-md-7">
                                        <textarea name="article" class="summernote-simple" required></textarea>
                                        @error('article')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="category[]" class="form-control inputtags">
                                        @error('category')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row mb-4">
                                    <div class="col-sm-12 col-md-7 offset-md-3">
                                        <button type="submit" class="btn btn-primary">Request Article</button>
                                    </div>
                                </div>
                            </div>
                        </form>
