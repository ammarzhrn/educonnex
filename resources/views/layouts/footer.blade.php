    ...
    <div class="w-full flex justify-between items-center max-md:grid max-md:grid-cols-1 gap-4">
        <div class="grid grid-cols-1 gap-6 w-1/4 max-md:w-full">
            ...
            <div class="grid grid-cols-4 w-72">
                <img class="h-7" src="images/yt_logo.png" alt="">
                <img class="h-7" src="images/ig_logo.png" alt="">
                <img class="h-7" src="images/fb_logo.png" alt="">
        ...
        <div class="flex justify-start items-center gap-6 w-2/4 max-md:w-full max-md:flex-col">
            ...
            <div class="flex justify-start items-center w-full gap-3">
                <img class="h-6" src="images/phone_logo.png" alt="">
                <a class="text-xl font-semibold text-zinc-600" href="#">0813 8921 5764</a>
            </div>
            <div class="flex justify-start items-center w-full gap-3">
                <img class="h-6" src="images/email_logo.png" alt="">
