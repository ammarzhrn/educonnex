<x-app-layout>
    ...
    <div class="w-full pt-16 bg-cover h-[600px] bg-center" style="background-image: url('{{ $news->thumbnail ? asset('storage/images/thumbnails/' . $news->thumbnail) : asset('images/thumbnail.png') }}');"></div>
            ...
            <div class="w-full h-auto grid grid-cols-2 max-md:grid-cols-1">
                ...
                <div class="w-full py-7 flex justify-center items-start flex-col gap-6 pr-5">
                    ...
                    <h1 class="text-base text-[#0088CC] font-medium w-full flex flex-row gap-4 max-md:flex-col max-md:gap-2">
                        <span class="text-neutral-500">{{$news->created_at->translatedFormat('d F Y')}}</span>
